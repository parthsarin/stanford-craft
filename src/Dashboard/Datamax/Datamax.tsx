  ...
  return (
    <div className="p-4">
      ...
      <div className="flex flex-row my-2">
        <button className="btn-rose" onClick={() => navigate('/dashboard/datamax/new')}>
          <FontAwesomeIcon icon={faPlus} className="mr-2" />
          New Quiz
        </button>
        <button className="btn-indigo" onClick={() => navigate('/dashboard/datamax/join')}>
      ...
      <div className="mt-2">
        <h2 className="text-xl">Active quizzes</h2>
      </div>
      <div className="mt-2">
        <h2 className="text-xl">Past quizzes</h2>
      </div>
    </div>
  );
}
